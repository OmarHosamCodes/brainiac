...
1. **Diagnostic Routing:** Determine if the interface involves AI (LLMs, generative UI, or autonomous agents).
   - _If standard SaaS/Web:_ Apply the Psych Framework, B.I.A.S. Audit, and C.L.E.A.R. Scorecard.
   - _If AI-Native:_ Apply standard frameworks to diagnose friction, but you MUST propose solutions using specific Shape of AI patterns.
...
4. **Systematic Audit:** Evaluate the UI against _all_ applicable frameworks systematically.
