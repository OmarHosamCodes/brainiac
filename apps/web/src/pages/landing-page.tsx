...
export function LandingPage() {
  ...
  return (
    <MarketingPageShell heroIsDark>
        ...
        <div className="relative mx-auto max-w-6xl px-6 pt-20 pb-16 md:px-10 md:pt-28 md:pb-24 lg:px-16">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-6 max-w-md text-lg leading-relaxed text-neutral-400 md:mt-8">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3 md:mt-10">
                ...
                <Button
                  ...
                  variant="ghost"
                  size="lg"
                  className="h-12 px-6 text-base text-neutral-300 hover:bg-neutral-800 hover:text-neutral-100"
                >
      ...
      <section className="relative overflow-hidden bg-[var(--marketing-ink)] text-neutral-100">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 py-14 text-center md:px-10 md:py-16 lg:px-16">
          <p className="text-[0.6875rem] font-bold tracking-[0.18em] text-neutral-500 uppercase">
            One workspace
          </p>
        ...
        <div className="mx-auto max-w-6xl px-6 py-20 md:px-10 md:py-28 lg:px-16">
          <div className="grid grid-cols-1 gap-16 md:grid-cols-2 md:gap-12 lg:gap-20">
            <div className="min-w-0">
              ...
              <LandingWorkspaceVignette className="mt-8 border-neutral-200 dark:border-neutral-800" />
            </div>
      ...
      <section className="w-full border-t border-neutral-200 bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-900">
        <div className="mx-auto max-w-6xl px-6 py-20 md:px-10 md:py-28 lg:px-16">
