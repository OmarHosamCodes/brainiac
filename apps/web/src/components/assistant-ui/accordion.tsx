...
const accordionVariants = cva("aui-accordion group/accordion flex w-full flex-col", {
  variants: {
    variant: {
      default: "",
...
function Accordion({
  ...
  variant,
  ...props
}: ComponentProps<typeof AccordionPrimitive.Root> & VariantProps<typeof accordionVariants>) {
  return (
