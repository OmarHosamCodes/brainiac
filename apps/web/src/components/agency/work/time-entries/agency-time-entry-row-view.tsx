...
export function AgencyTimeEntryRowView({ view, deletingEntryIds }: AgencyTimeEntryRowViewProps) {
  const {
    group,
    projects,
    tasks,
          ...
          {group.entries.map((entry) => (
            <div
              ...
              className={cn(
                agencyTimeEntryGridClass,
                agencyTimeEntryRowClass,
                "items-center border-t border-default/60 py-2 text-xs",
              )}
            >
              <div className="flex min-w-0 items-center gap-3 pr-4">
                <div className={descriptionLeadingSlotClass} aria-hidden />
