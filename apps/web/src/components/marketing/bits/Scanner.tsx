...
function directionToFloat(dir: ScanDirection): number {
  switch (dir) {
    case "horizontal":
      return 1.0;
    case "diagonal":
...
const ctxMap = new WeakMap<HTMLElement, ScannerContext>();
...
export default function Scanner({
  ...
  useEffect(() => {
    ...
    // ponytail: window listeners so focus follows the cursor over the auth copy.
