...
export function FlowGraph({
  ...
  className,
  ...props
}: Omit<ComponentProps<"div">, "children" | "nodes" | "edges" | "visibleCount"> & {
  ...
  return (
    <div
      ...
      className={cn(paper, "w-full max-w-md overflow-x-auto rounded-2xl p-4", className)}
      {...props}
    >
        ...
        {shown.map((node) => (
          <div
            ...
            className={cn(
              ...
              node.state === "pending" && "border-foreground/8 text-foreground/35 border-dashed",
            )}
            style={{
