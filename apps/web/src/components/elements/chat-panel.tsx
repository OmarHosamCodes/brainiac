...
export function ChatPanelMessages({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
...
export function ChatPanelUserMessage({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
...
export function ChatPanelAssistantMessage({ className, ...props }: ComponentProps<"p">) {
  return (
    <p
      data-slot="chat-panel-assistant-message"
      className={cn("text-foreground/70 max-w-[85%] self-start text-xs leading-relaxed", className)}
      {...props}
    />
  );
}

export function ChatPanelTyping({ className, ...props }: Omit<ComponentProps<"div">, "children">) {
  return (
    <div
      data-slot="chat-panel-typing"
      className={cn("fade-in animate-in flex gap-1 self-start px-1 duration-300", className)}
      {...props}
    >
