...
> & {
  ...
  return (
    <div
      ...
      className={cn(paper, "flex w-full max-w-md flex-col gap-3 rounded-2xl p-4", className)}
      {...props}
    >
            ...
            >
              <div className="flex flex-col gap-0.5">
                <span className="flex items-baseline gap-1.5">
                  ...
                  {recommended && (
                    <span className={cn(mono, "shrink-0 text-blue-600 dark:text-blue-400")}>
                      pick
                    </span>
                  )}
                </span>
                <span className="text-foreground/45 truncate text-xs">{option.headline}</span>
              </div>
