  ...
  return (
    <section className="py-1 first:pt-0">
      <button
        type="button"
        className={cn(
          "mb-0.5 flex w-full items-center justify-between gap-2 rounded-lg px-2 py-1.5 text-left transition-colors hover:bg-default/60",
      ...
      >
        <span className="min-w-0 truncate text-xs font-semibold text-highlighted">{clientName}</span>
