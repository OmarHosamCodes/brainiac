...
type AgencySettingsRatesPaneViewProps = {
  viewModel: AgencySettingsRatesPaneViewModel;
};

export function AgencySettingsRatesPaneView({ viewModel }: AgencySettingsRatesPaneViewProps) {
  const { isPending, rates } = viewModel;
