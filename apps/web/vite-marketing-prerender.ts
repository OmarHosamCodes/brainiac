...
const MARKETING_SHELL = `<div id="marketing-prerender-shell" class="marketing-prerender-shell" style="position:fixed;inset:0;z-index:9999;overflow:auto;min-height:100vh;background:#09090b;color:#fafafa;font-family:'IBM Plex Sans',system-ui,sans-serif">
  <div style="max-width:72rem;margin:0 auto;padding:5rem 1.5rem 4rem">
    ...
    <p style="max-width:28rem;margin-top:1.5rem;font-size:1.125rem;line-height:1.625;color:#71717a">
