...
useSeoMeta({
    title: "Privacy Policy | Brainiac",
    description: "How Brainiac collects, uses, stores, and protects personal information across its website and product surfaces.",
});
...
const sections = [
    {
        ...
        intro: "This Privacy Policy explains how Brainiac collects, uses, discloses, and safeguards personal information when you visit our website, create an account, or use our workspace and related services.",
        paragraphs: [
