  ...
  >
    ...
    >
      <div class="w-full max-w-2xl">
        ...
        >
          <UIcon name="i-lucide-brain-circuit" class="size-3.5 text-primary" />
        ...
        >
          Brainiac
          <span class="text-primary block mt-1 text-[0.75em] hero-title-accent">Studio</span>
        </h1>

        <!-- Body copy -->
        <p class="text-lg md:text-xl text-dimmed max-w-lg leading-relaxed mb-10 hero-body">
          An infinite spatial workspace for your mind. Organize, collaborate, and evolve with AI
          agents — distraction-free.
        </p>
        ...
        <div class="flex flex-wrap items-center gap-4 hero-ctas">
          ...
          <UButton to="/marketplace" size="lg" variant="outline" color="neutral" class="hero-cta-2">
            Marketplace
          </UButton>
          <UButton to="/pricing" size="lg" variant="ghost" color="neutral" class="hero-cta-3">
            Pricing
          </UButton>
        </div>
      </div>
    ...
    <div class="w-full flex justify-center pb-8 hero-status">
      ...
      >
        ...
        <span v-if="healthCheck.isSuccess.value" class="text-[10px] font-medium text-dimmed">
