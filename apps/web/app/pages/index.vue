...
<template>
  <div
    class="relative h-screen w-screen flex flex-col items-center justify-center overflow-hidden bg-white dark:bg-neutral-950 selection:bg-blue-500/30"
  >
    <Header />

    <div class="absolute inset-0 -z-10">
      <div
        class="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(59,130,246,0.05),transparent_50%)]"
      />
      <div
    ...
    <div class="max-w-3xl w-full px-6 text-center">
      <div
        class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-neutral-900/5 dark:bg-neutral-100/5 border border-neutral-200/50 dark:border-neutral-800/50 text-[10px] font-bold uppercase tracking-widest text-neutral-500 mb-8 animate-fade-in"
      >
      ...
      <h1
        class="text-6xl md:text-8xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100 mb-8 animate-title"
      >
        Brainiac <span class="text-blue-500 text-6xl md:text-7xl block md:inline">Studio</span>
      </h1>

      <p
        class="text-lg md:text-xl text-neutral-500 dark:text-neutral-400 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-delayed"
      >
        An infinite spatial workspace for your mind. Organize, collaborate, and evolve with AI
        agents in a beautiful, distraction-free environment.
      </p>
    ...
    <div class="fixed bottom-12 left-1/2 -translate-x-1/2 animate-fade-in-delayed-2">
      <div
        class="flex items-center gap-3 px-4 py-2 rounded-full border border-neutral-200/50 dark:border-neutral-800/50 bg-white/50 dark:bg-neutral-950/50 backdrop-blur-xl"
      >
        <div
