...
useSeoMeta({
    title: "Terms of Service | Brainiac",
    description: "Terms governing access to Brainiac, including account use, acceptable use, subscriptions, and service availability.",
});
...
const sections = [
    {
        ...
        intro: "These Terms of Service govern your access to Brainiac, including our website, workspace tools, marketplace surfaces, and related services.",
        paragraphs: [
    ...
    },
    {
        ...
        intro: "Brainiac is built for legitimate collaboration and creative work. You may not use the service in ways that interfere with others, violate law, or abuse our infrastructure.",
        bullets: [
...
<template>
    <LegalPageShell
        ...
        summary="Clear rules for using Brainiac, from account security and acceptable use to AI-assisted output, billing, and service limits."
