        ...
        >
          ...
          <template v-if="messages.length === 0 && !isLoadingConversation" #default>
            <div class="flex h-full flex-col items-center justify-center px-4 py-8 sm:px-5">
              <div
                class="w-full max-w-md rounded-[1.9rem] border border-neutral-200/70 bg-white/85 p-5 shadow-xl shadow-black/5 dark:border-neutral-800/70 dark:bg-neutral-900/75"
              >
                <div class="flex items-start gap-4">
                  <div
                    class="flex size-11 shrink-0 items-center justify-center rounded-[1.4rem] bg-neutral-950 text-white shadow-md dark:bg-white dark:text-neutral-950"
                  >
                  ...
                  <div class="min-w-0">
                    ...
                    >
                      Start with the workspace that is already in view.
                    </h3>
      ...
      <div class="space-y-3">
        <div v-if="selectedNodes.length > 0" class="flex items-start justify-between gap-2">
          <div class="flex min-w-0 flex-wrap items-center gap-1.5">
            ...
            >
              <span class="max-w-[10rem] truncate text-[11px] font-medium">{{ node.title }}</span>
              <UButton
                color="neutral"
                variant="ghost"
                size="xs"
