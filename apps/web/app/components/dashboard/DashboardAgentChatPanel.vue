...
<template>
    ...
    >
        <div class="flex items-center justify-between px-6 py-5 border-b border-neutral-200/30 dark:border-neutral-800/30">
            <div class="flex items-center gap-3">
                <div class="flex size-8 items-center justify-center rounded-xl bg-primary-500 text-white shadow-lg shadow-primary-500/20">
                    <UIcon name="i-lucide-sparkles" class="size-4" />
                </div>
                <div>
                    <h2 class="text-sm font-bold tracking-tight text-neutral-900 dark:text-neutral-100">Copilot</h2>
                    <p class="text-[10px] font-medium text-neutral-500 uppercase tracking-widest">{{ scopeLabel }}</p>
                </div>
            </div>
        ...
        >
            <template v-if="messages.length === 0">
                <div class="space-y-6">
                    <div class="p-5 rounded-3xl bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200/50 dark:border-neutral-800/50">
                        <p class="text-xs font-semibold text-neutral-900 dark:text-neutral-100 mb-1">How can I help?</p>
                        <p class="text-xs text-neutral-500 leading-relaxed">I can analyze your nodes, find connections, or help you brainstorm new ideas.</p>
                    </div>

                    <div class="space-y-2">
                        <p class="text-[10px] font-bold text-neutral-400 uppercase tracking-widest ml-1">Suggestions</p>
                        <div class="flex flex-wrap gap-2">
                            <button
                                v-for="prompt in promptSuggestions"
                                :key="prompt"
                                type="button"
                                class="px-4 py-2 rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 text-xs font-medium text-neutral-600 dark:text-neutral-400 hover:border-primary-500/50 hover:text-primary-600 transition-all active:scale-95 shadow-sm"
            ...
            <div v-if="isPending" class="flex justify-start">
                <div class="flex items-center gap-2 px-4 py-2 bg-white dark:bg-neutral-900 border border-neutral-200/50 dark:border-neutral-800/50 rounded-2xl text-xs text-neutral-500">
        ...
        <div class="p-6 border-t border-neutral-200/30 dark:border-neutral-800/30 bg-neutral-50/50 dark:bg-neutral-900/20">
            <div class="relative">
                <UTextarea
                    v-model="draft"
                    :rows="2"
            ...
            <div class="mt-4 flex items-center justify-between gap-4">
                ...
                <div v-if="selectedNodes.length > 0" class="flex -space-x-2">
                    ...
                    <div v-if="selectedNodes.length > 3" class="size-5 rounded-full border border-white dark:border-neutral-950 bg-neutral-200 dark:bg-neutral-800 flex items-center justify-center text-[8px] text-neutral-500 font-bold">
