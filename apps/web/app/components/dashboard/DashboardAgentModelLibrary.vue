...
<template>
    ...
    >
        <template #body>
            <div
                class="grid max-h-[70vh] gap-0 md:grid-cols-[17rem_minmax(0,1fr)]"
            >
                <aside
                        ...
                        >
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        >Paid models disabled until credits are
                                        added.</span
                                    >
                                </div>
                            </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-1.5">
                                <UButton
                                    block
                                    :variant="
                                        favoritesOnlyValue ? 'solid' : 'outline'
                                    "
                                    color="neutral"
                                    size="sm"
                                    ...
                                    "
                                    @click="
                                        favoritesOnlyValue = !favoritesOnlyValue
                                    "
                                >
                ...
                <section
                    class="min-h-0 bg-white/50 p-4 sm:p-6 dark:bg-neutral-900/50"
                >
                    <div class="space-y-5">
                        ...
                        <template v-else>
                            ...
                            <div class="space-y-3">
                                ...
                                >
                                    ...
                                    <p
                                        class="mt-4 text-sm font-bold text-neutral-900 dark:text-neutral-50"
                                    >
                                        No models found
                                    </p>
                                    <p
