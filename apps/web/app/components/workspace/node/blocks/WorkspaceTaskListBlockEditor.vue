...
const openTaskCount = computed(
    () => props.block.tasks.filter((task) => !task.completed).length,
);
                    ...
                    <div class="space-y-4">
                        <UFormField size="sm">
                            ...
                            <UInput
                                ...
                                class="rounded-xl"
                                @update:model-value="
                                    updateTaskDueDate(task.id, $event)
                                "
                            />
                        </UFormField>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <UFormField size="sm">
                                ...
                                <USelect
                                    ...
                                    class="rounded-xl"
                                    @update:model-value="
                                        updateTaskPriority(task.id, $event)
                                    "
                                />
                            </UFormField>
                            ...
                            <UFormField size="sm">
                                ...
                                <USelect
                                    ...
                                    class="rounded-xl"
                                    @update:model-value="
                                        updateTaskDomain(task.id, $event)
                                    "
                                />
                            </UFormField>
                        </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <UFormField size="sm">
                            ...
                            <UInput
                                ...
                                @update:model-value="
                                    updateTaskEstimate(task.id, $event)
                                "
                            />
                        </UFormField>
                    </div>
