      ...
      <div class="mb-6 flex items-center justify-between gap-4">
        ...
        <div class="flex-1 px-8">
          ...
          <div class="mt-2 text-center">
            <p class="text-sm font-bold text-highlighted uppercase tracking-tighter">
              {{ summary.signal }}
            </p>
          </div>
        </div>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      ...
      <div class="space-y-4">
        ...
        <div
          ...
          class="flex flex-col items-center justify-center rounded-3xl border border-dashed border-success/20 bg-success/5 py-12 text-center"
        >
      ...
      <div class="space-y-4">
        ...
        <div
          ...
          class="flex flex-col items-center justify-center rounded-3xl border border-dashed border-error/20 bg-error/5 py-12 text-center"
        >
