...
<template>
  <div class="space-y-8">
    ...
    >
      <div class="absolute inset-0 bg-linear-to-b from-primary/5 to-transparent opacity-50" />
        ...
        >
          <div class="min-w-0 flex-1">
            <UInput
              ...
              @update:model-value="updateEntryLabel(entry.id, $event)"
            />
          ...
          <div class="flex items-center gap-3">
            <div class="w-24">
              <UInput
                ...
                @update:model-value="updateEntryValue(entry.id, $event)"
              />
            </div>
