...
function updateSettings(mutator: (settings: WorkspaceTimeOrchestratorBlock["settings"]) => void) {
  mutateTypedBlock(props.tabId, props.block.id, "time-orchestrator", (entry) => {
...
<template>
  <div class="space-y-6">
    <div class="rounded-3xl border border-muted/20 bg-elevated/10 p-5 backdrop-blur-sm">
      <div class="flex flex-wrap items-start justify-between gap-4">
        <div class="space-y-2">
          <div class="flex items-center gap-2 text-primary">
            <UIcon name="i-lucide-calendar-clock" class="size-5" />
            <p class="text-[10px] font-bold uppercase tracking-[0.2em]">Time Orchestrator</p>
          </div>
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      >
        ...
        <p class="mt-2 text-2xl sm:text-3xl font-black tracking-tight" :class="card.valueClassName">
          {{ card.value }}
        </p>
        <p class="mt-1 text-[10px] font-bold uppercase tracking-[0.14em] text-muted/40">
    ...
    <div class="rounded-3xl border border-muted/20 bg-default/40 px-5 py-4">
      <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div v-for="stat in secondarySummaryStats" :key="stat.key" class="space-y-1">
          <p class="text-[10px] font-bold uppercase tracking-[0.2em] text-muted/60">
            {{ stat.label }}
          </p>
    ...
    <div class="grid gap-6 xl:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
      <section class="rounded-3xl border border-muted/20 bg-default/40 p-5">
        <div class="flex items-center justify-between gap-3">
          ...
          <UBadge color="neutral" variant="soft" size="sm" class="rounded-2xl">
          ...
          >
            <div class="flex flex-wrap items-start justify-between gap-3">
              <div class="min-w-0 flex-1 space-y-2">
                <p class="font-bold leading-tight text-highlighted">
                ...
                <div class="flex flex-wrap items-center gap-2">
                  ...
                  <UBadge color="primary" variant="soft" size="sm" class="rounded-2xl">
        ...
        >
          ...
          <p class="mt-2 text-sm text-muted">Adjust the filters above to widen the view.</p>
        </div>
      </section>
        ...
        <section class="rounded-3xl border border-muted/20 bg-default/40 p-5">
          <div class="flex items-center justify-between gap-3">
            <div>
              ...
              <p class="mt-1 text-sm text-muted">Open work grouped by team domain.</p>
            </div>
            <UBadge color="neutral" variant="soft" size="sm" class="rounded-2xl">
          ...
          <div class="mt-4 space-y-3">
            ...
            >
              <p class="text-sm text-muted">No domain data for the active filters.</p>
            </div>
          </div>
        </section>
        ...
        <section class="rounded-3xl border border-muted/20 bg-default/40 p-5">
          ...
          <div class="mt-4 space-y-5">
            <div>
              ...
              <p v-if="(summary?.overdue.length ?? 0) === 0" class="mt-2 text-xs text-muted">
                Nothing overdue.
              </p>
            </div>
            ...
            <div class="border-t border-muted/10 pt-5">
              ...
              <p v-if="(summary?.upcoming.length ?? 0) === 0" class="mt-2 text-xs text-muted">
    ...
    >
      ...
      >
        ...
        <p v-if="quadrant.tasks.length === 0" class="mt-4 text-xs text-muted">
