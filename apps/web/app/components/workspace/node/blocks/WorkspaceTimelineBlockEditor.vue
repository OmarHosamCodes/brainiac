...
function getNextStatus(
    status: WorkspaceTimelineMilestoneStatus,
): WorkspaceTimelineMilestoneStatus {
    const currentIndex = WORKSPACE_TIMELINE_MILESTONE_STATUSES.indexOf(status);
    const nextIndex =
        currentIndex < 0
            ? 0
            : (currentIndex + 1) % WORKSPACE_TIMELINE_MILESTONE_STATUSES.length;
        ...
        <div class="relative pl-8 space-y-8">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div class="flex-1 min-w-0">
                            <div class="flex flex-wrap items-center gap-2 mb-1">
                                <span
                                    class="text-[10px] font-black uppercase tracking-[0.2em] text-muted/60"
                                >
                                ...
                                <UBadge
                                    ...
                                    @click.stop="
                                        cycleMilestoneStatus(milestone.id)
                                    "
                                >
                                    <UIcon
                            ...
                            <UInput
                                ...
                                @update:model-value="
                                    updateMilestoneTitle(milestone.id, $event)
                                "
                            />
                    ...
                    >
                        ...
                        <UFormField size="sm">
                            ...
                            <UTextarea
                                ...
                                @update:model-value="
                                    updateMilestoneNote(milestone.id, $event)
                                "
                            />
                        </UFormField>
                    </div>
            ...
            >
                <UIcon
                    ...
                    class="size-8 text-muted/20 mb-3"
                />
                <p
                    class="text-[10px] font-bold uppercase tracking-[0.2em] text-muted/60"
                >
