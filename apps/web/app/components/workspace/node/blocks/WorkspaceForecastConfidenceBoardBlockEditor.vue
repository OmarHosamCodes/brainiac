  ...
  Object.fromEntries(
    WORKSPACE_SALES_FORECAST_BUCKETS.map((bucket) => [
      ...
      props.block.deals
        ...
        .sort((left, right) => right.confidence - left.confidence || right.valueEgp - left.valueEgp),
    ]),
  ...
  <div class="space-y-6">
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      <div class="rounded-[28px] bg-success/5 p-5">
        <p class="text-[10px] font-bold uppercase tracking-[0.24em] text-success/70">Commit Revenue</p>
      ...
      <div class="rounded-[28px] bg-primary/5 p-5">
        <p class="text-[10px] font-bold uppercase tracking-[0.24em] text-primary/70">Weighted Forecast</p>
      ...
      <div class="rounded-[28px] bg-warning/5 p-5">
        <p class="text-[10px] font-bold uppercase tracking-[0.24em] text-warning/70">Coverage vs Target</p>
        <p class="mt-2 text-4xl font-black tracking-tight" :class="getCoverageTextClasses(summary.coveragePercent)">
    ...
    <div class="grid gap-4 xl:grid-cols-4">
      <section
        ...
        :key="bucket"
        class="rounded-[32px] border p-4"
        :class="getBucketClasses(bucket)"
      >
        ...
        <p class="mt-2 text-sm text-muted">
          Weighted {{ formatCurrency(getBucketSummary(bucket).weightedValue) }}
        </p>
