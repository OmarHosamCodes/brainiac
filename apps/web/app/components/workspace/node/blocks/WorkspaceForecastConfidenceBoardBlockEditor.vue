    ...
    <div class="space-y-6">
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <div class="rounded-[28px] bg-success/5 p-5">
                <p
                    class="text-[10px] font-bold uppercase tracking-[0.24em] text-success/70"
                >
                    Commit Revenue
                </p>
            ...
            <div class="rounded-[28px] bg-primary/5 p-5">
                <p
                    class="text-[10px] font-bold uppercase tracking-[0.24em] text-primary/70"
                >
                    Weighted Forecast
                </p>
            ...
            <div class="rounded-[28px] bg-error/5 p-5">
                <p
                    class="text-[10px] font-bold uppercase tracking-[0.24em] text-error/70"
                >
                    At-Risk Value
                </p>
            ...
            <div class="rounded-[28px] bg-warning/5 p-5">
                <p
                    class="text-[10px] font-bold uppercase tracking-[0.24em] text-warning/70"
                >
                    Coverage vs Target
                </p>
                <p
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 px-1">
            <div>
                ...
                <p class="text-sm text-muted">
                    Bucket deals by confidence, then compare the weighted
                    forecast against the target.
                </p>
            </div>
                    ...
                    <UInput
                        ...
                        @update:model-value="
                            mutateBlock(tabId, block.id, (entry) => {
                                if (entry.type !== 'forecast-confidence-board')
                                    return;
        ...
        <div class="grid gap-4 xl:grid-cols-4">
            <section
                ...
                :class="[
                    ...
                    dragOverBucket === bucket
                        ? 'ring-2 ring-primary/20 brightness-110'
                        : '',
                ]"
            ...
            >
                <div class="flex items-start justify-between gap-3">
                    <div>
                        <p
                            class="text-[10px] font-bold uppercase tracking-[0.24em] text-muted"
                        >
                            {{ workspaceSalesForecastBucketLabels[bucket] }}
                        </p>
                        <p
                            class="mt-2 text-2xl font-black tracking-tight text-highlighted"
                        >
                            {{
                                formatCurrency(
                        ...
                        <div class="flex items-start justify-between gap-3">
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="mt-1 text-sm text-muted">
                                    ...
                                    {{
                                        formatCurrency(
                                            getForecastDealWeightedValue(deal),
                                        )
                                    }}
                                </p>
                            </div>
