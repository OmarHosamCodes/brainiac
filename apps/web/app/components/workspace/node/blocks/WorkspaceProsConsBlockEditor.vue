    ...
    <div class="space-y-8">
        ...
        >
            ...
            <div class="mb-4 flex items-center justify-between gap-4">
                <div>
                    <p
                        class="text-[10px] font-bold uppercase tracking-[0.2em] opacity-70"
                    >
                        Verdict
                    </p>
                    <p
                ...
                <div class="flex-1 px-4 sm:px-8">
                    <div
                        class="relative h-2 overflow-hidden rounded-full bg-muted/20"
                    >
                        <div
                    ...
                    <div class="mt-4 text-center">
                        <p
                            class="mb-1 text-[10px] font-bold uppercase tracking-[0.2em] opacity-70"
                        >
                            Score Delta
                        </p>
                ...
                >
                    <div class="flex items-start gap-3">
                        <UInput
                            ...
                            @update:model-value="
                                updateItemText('pros', item.id, $event)
                            "
                        />
                    ...
                    >
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            <button
                                ...
                                @click="
                                    updateItemWeight('pros', item.id, weight)
                                "
                            >
                                {{ weight }}
                            </button>
                ...
                >
                    <div class="flex items-start gap-3">
                        <UInput
                            ...
                            @update:model-value="
                                updateItemText('cons', item.id, $event)
                            "
                        />
                    ...
                    >
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            <button
                                ...
                                @click="
                                    updateItemWeight('cons', item.id, weight)
                                "
                            >
                                {{ weight }}
                            </button>
