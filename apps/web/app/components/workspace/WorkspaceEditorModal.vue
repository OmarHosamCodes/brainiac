...
const modalTitle = computed(() =>
    props.mode === "create" ? "Create node" : "Edit node",
);
...
const selectedBlockKeys = computed(
    () =>
        new Set(
            props.featuredBlocks.map(
                (entry) => `${entry.tabId}:${entry.blockId}`,
            ),
        ),
);
...
const groupedBlockOptions = computed(() => {
    ...
    for (const option of props.availableBlocks) {
        const existingGroup = groups.find(
            (entry) => entry.tabId === option.tabId,
        );
...
const submitLabel = computed(() =>
    props.mode === "create" ? "Create node" : "Save changes",
);
...
function isFeaturedBlockSelected(
    ...
    if (isSelected) {
        emit(
            ...
            props.featuredBlocks.filter(
                (entry) =>
                    !(
                        entry.tabId === option.tabId &&
                        entry.blockId === option.blockId
                    ),
            ),
        );
        return;
        ...
        <template #body>
            ...
            >
                <div class="min-w-0">
                    ...
                    <h3
                        class="mt-1 truncate text-lg font-semibold text-highlighted"
                    >
                        {{ draftTitle }}
                    </h3>
            ...
            >
                <div class="space-y-6">
                    <div
                        class="rounded-2xl border border-muted/30 bg-default/60 p-4"
                    >
                        <p class="text-sm font-semibold text-highlighted">
                            Node Details
                        </p>
                        <p class="mt-1 text-sm text-muted">
                            Set the title and summary that identify this node
                            across the board and its card preview.
                        </p>
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                <p class="mt-1 text-sm text-muted">
                                    Choose whether this node stands alone or
                                    orchestrates work across connected nodes.
                                </p>
                            </div>
                        ...
                        <div class="mt-4 grid gap-2 sm:grid-cols-2">
                            ...
                            >
                                ...
                                <p class="mt-1 text-xs text-muted">
                                    Regular workspace node with no graph links.
                                </p>
                            </button>
                            ...
                            <button
                                ...
                                "
                                @click="
                                    emit('update:node-type', 'orchestrator')
                                "
                            >
                                <p class="text-sm font-medium text-highlighted">
                                    Orchestrator
                                ...
                                <p class="mt-1 text-xs text-muted">
                                    Can connect to standard nodes and aggregate
                                    cross-node tasks.
                                </p>
                            </button>
                        </div>
                    ...
                    >
                        ...
                        <p class="mt-1 text-sm text-muted">
                            Give the node a visual identity on the canvas
                        ...
                        <div class="mt-4 flex flex-wrap gap-3">
                            ...
                            >
                                <span
                                    class="node-tint-swatch size-5 rounded-full border"
                                />
                                <UIcon
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-1 text-sm text-muted">
                                Choose which blocks surface structured summaries
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <template v-else>
                            ...
                            <div
                                class="max-h-[28rem] space-y-4 overflow-y-auto pr-1"
                            >
                                <section
