  ...
  >
    ...
    <div class="mb-5 flex items-center justify-between gap-3">
      <div class="flex items-center gap-2">
        <div
          ...
          :class="
            selected
              ? 'bg-primary-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]'
    ...
    >
      ...
      <div class="flex -space-x-1.5">
        <div
          class="size-4 rounded-full border border-white dark:border-neutral-900 bg-neutral-200 dark:bg-neutral-800"
        />
        <div
          class="size-4 rounded-full border border-white dark:border-neutral-900 bg-neutral-300 dark:border-neutral-700"
        />
      </div>
    </div>
  </div>
